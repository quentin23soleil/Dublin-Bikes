...
public class WantABikeFragment extends BaseFragment {

    private ArrayList<Station> stations;
    private boolean mShowingBack;
    private MapFragment mapFrag;

    public static WantABikeFragment newInstance() {
        WantABikeFragment fragment = new WantABikeFragment();
        return fragment;
    }
    ...
    public void onResume() {
        super.onResume();
        ((Home) getActivity()).setTitle(getResources().getString(R.string.i_want_a_bike));
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        api.execute("dublin.json", null, new OnApiFinished() {
            ...
            public void success(String json) {
                ...
                b.putInt("mode", Constants.WANT_BIKE_MODE);
    ...
    public String getTitle() {
        return getString(R.string.i_want_a_bike);
    }
